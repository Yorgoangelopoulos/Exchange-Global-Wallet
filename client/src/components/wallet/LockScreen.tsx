        ...
        >
          <div className="relative">
            <Input
              ...
              className="bg-transparent border-t-0 border-x-0 border-b-2 border-gray-700 rounded-none focus:border-blue-500 py-2 pl-8 pr-10 text-white placeholder:text-gray-500"
              autoFocus
            />
